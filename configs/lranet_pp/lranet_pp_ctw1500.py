...
train_pipeline = [
    ...
    dict(type='Collect', keys=['img', 'p3_maps', 'p4_maps', 'p5_maps','lra_polys', 'polygons_area', 'gt_texts','lv_tps_coeffs'])
]
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            ann_file=data_root + 'ctw1500/ctw1500_training.json',
            img_prefix=data_root + 'ctw1500',
            pipeline=train_pipeline)),
    val=dict(
        type=dataset_type,
        ann_file=data_root + 'ctw1500/ctw1500_test.json',
        img_prefix=data_root + 'ctw1500',
...
lr_config = dict(policy='step', step=[5000,8000],by_epoch=False,)
runner = {
